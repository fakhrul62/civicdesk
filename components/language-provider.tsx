...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "submit.errorName": "Please enter your full name.",
    "submit.errorEmail": "Please enter a valid email address.",
    ...
    "submit.namePlaceholder": "Your full name",
    "submit.emailPlaceholder": "your.email@example.com",
    "submit.guestSubmitInfo": "You can submit this complaint without an account. Your ticket ID will be provided for tracking.",
    "submit.createAccountInfo": "Want to create an account to manage your complaints? You can do so after submitting this one.",
  ...
  bn: {
    ...
    "submit.errorName": "অনুগ্রহ করে আপনার পূর্ণ নাম লিখুন।",
    "submit.errorEmail": "অনুগ্রহ করে সঠিক ইমেইল ঠিকানা লিখুন।",
    "submit.errorNoGeo": "আপনার ব্রাউজার লোকেশন শনাক্তকরণ সমর্থন করে না।",
    "submit.errorGeo": "বর্তমান লোকেশন পড়া যায়নি। আপনি হাতে ঠিকানা লিখতে পারেন।",
    "submit.namePlaceholder": "আপনার পূর্ণ নাম",
    "submit.emailPlaceholder": "your.email@example.com",
    "submit.guestSubmitInfo": "আপনি অ্যাকাউন্ট ছাড়াই এই অভিযোগ জমা দিতে পারেন। ট্র্যাকিংয়ের জন্য টিকিট আইডি দেওয়া হবে।",
    "submit.createAccountInfo": "আপনার অভিযোগ পরিচালনা করতে অ্যাকাউন্ট তৈরি করতে চান? এই অভিযোগ জমা দেওয়ার পরে করতে পারবেন।",
