...
// Mock chart data
const categoryData = [
  { name: "Road & Infrastructure", count: 234, percentage: 100 },
  { name: "Water Supply", count: 189, percentage: 81 },
  { name: "Electricity", count: 165, percentage: 70 },
  { name: "Waste Management", count: 142, percentage: 61 },
  { name: "Public Safety", count: 98, percentage: 42 },
  { name: "Parks & Recreation", count: 75, percentage: 32 },
  { name: "Noise Complaint", count: 62, percentage: 26 },
  { name: "Building Permits", count: 41, percentage: 18 },
];
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-4">
        {[
          { label: "Total Complaints", value: "536", change: "+12%" },
          { label: "Avg. Resolution", value: "48h", change: "-8%" },
          { label: "SLA Compliance", value: "87%", change: "+3%" },
