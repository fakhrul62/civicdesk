...
export default function AdminTicketsPage() {
  ...
  const filtered = mockTickets.filter((t) => {
    const matchesSearch =
      ...
      t.citizen_name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesStatus =
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
            ...
            {filtered.map((ticket) => (
              ...
              >
                ...
                <TableCell className="hidden md:table-cell">
                  <p className="text-sm">{ticket.citizen_name}</p>
                </TableCell>
                <TableCell>
                  <Badge
                    variant="outline"
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        <span>Showing {filtered.length} of {mockTickets.length} tickets</span>
        <div className="flex items-center gap-2">
